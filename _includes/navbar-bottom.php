<div class="navbar navbar-default navbar-fixed-bottom non-mobile-hide">
  <div class="container">
    <div class="navbar-collapse collapse bottom-collapse"> <!-- NOTE! The extra bottom-collapse class put on here -->
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="https://twitter.com/torreypinesfilm" target="_new"><div class="circle-icon social-icons"><img src="/img/twitter-circle-icon.png"></div></a></li>
      </ul>
    </div><!--/.nav-collapse -->
  </div>
</div>
